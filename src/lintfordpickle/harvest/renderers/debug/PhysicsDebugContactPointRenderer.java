...
public class PhysicsDebugContactPointRenderer extends BaseRenderer implements ICollisionCallback {
	...
	public PhysicsDebugContactPointRenderer(RendererManager rendererManager, PhysicsWorld world, int entityGroupID) {
