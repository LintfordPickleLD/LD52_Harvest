...
public class PhysicsDebugGridRenderer extends BaseRenderer {
	...
	public PhysicsDebugGridRenderer(RendererManager rendererManager, PhysicsWorld world, int entityGroupID) {
